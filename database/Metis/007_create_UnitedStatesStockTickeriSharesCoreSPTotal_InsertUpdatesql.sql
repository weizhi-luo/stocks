...
CREATE PROCEDURE dbo.UnitedStatesStockTickeriSharesCoreSPTotal_InsertUpdate 
...
BEGIN
    ...
    FROM [dbo].[UnitedStatesStockTickeriSharesCoreSPTotal] t
    INNER JOIN @data s
    ...
    INSERT INTO [dbo].[UnitedStatesStockTickeriSharesCoreSPTotal]
    (
       [Ticker]
      ,[Name]
      ,[SectorId]
	...
	ON ex.[Name] = s.[Exchange]
    WHERE NOT EXISTS (
        SELECT 1 FROM [dbo].[UnitedStatesStockTickeriSharesCoreSPTotal]
