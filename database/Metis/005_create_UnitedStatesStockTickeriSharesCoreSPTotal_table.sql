...
CREATE TABLE dbo.UnitedStatesStockTickeriSharesCoreSPTotal
(
...
CREATE UNIQUE NONCLUSTERED INDEX IX_UnitedStatesStockTickeriSharesCoreSPTotal_Ticker ON dbo.UnitedStatesStockTickeriSharesCoreSPTotal
(
    [Ticker]
)
INCLUDE
